        ...
        module BackupDR
          module Rest
            ...
            class ServiceStub
              ...
              ##
              # Baseline implementation for the remove_data_source REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::RemoveDataSourceRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              # @return [::Google::Longrunning::Operation]
              #   A result object deserialized from the server's reply
              def remove_data_source request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_remove_data_source_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
              ...
              ##
              # Baseline implementation for the set_internal_status REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::SetInternalStatusRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              # @return [::Google::Longrunning::Operation]
              #   A result object deserialized from the server's reply
              def set_internal_status request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_set_internal_status_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
              ...
              ##
              # Baseline implementation for the initiate_backup REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::InitiateBackupRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              #   A result object deserialized from the server's reply
              def initiate_backup request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_initiate_backup_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::BackupDR::V1::InitiateBackupResponse.decode_json response.body, ignore_unknown_fields: true
              ...
              ##
              # Baseline implementation for the abandon_backup REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::AbandonBackupRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              # @return [::Google::Longrunning::Operation]
              #   A result object deserialized from the server's reply
              def abandon_backup request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_abandon_backup_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
              ...
              ##
              # Baseline implementation for the finalize_backup REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::FinalizeBackupRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              # @return [::Google::Longrunning::Operation]
              #   A result object deserialized from the server's reply
              def finalize_backup request_pb, options = nil
                raise ::ArgumentError, "request must be provided" if request_pb.nil?

                verb, uri, query_string_params, body = ServiceStub.transcode_finalize_backup_request request_pb
                query_string_params = if query_string_params.any?
                                        query_string_params.to_h { |p| p.split "=", 2 }
                                      else
                                        {}
              ...
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::FetchAccessTokenRequest]
              #   A request object representing the call parameters. Required.
              # @param options [::Gapic::CallOptions]
              #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
              #
              ...
              def fetch_access_token request_pb, options = nil
                ...
                operation = ::Gapic::Rest::TransportOperation.new response
                result = ::Google::Cloud::BackupDR::V1::FetchAccessTokenResponse.decode_json response.body, ignore_unknown_fields: true
              ...
              # @private
              #
              # GRPC transcoding helper method for the remove_data_source REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::RemoveDataSourceRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_remove_data_source_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
              ...
              # @private
              #
              # GRPC transcoding helper method for the set_internal_status REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::SetInternalStatusRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_set_internal_status_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/{data_source}:setInternalStatus",
                                                          body: "*",
                                                          matches: [
                                                            ["data_source", %r{^projects/[^/]+/locations/[^/]+/backupVaults/[^/]+/dataSources/[^/]+/?$}, false]
                                                          ]
                                                        )
                transcoder.transcode request_pb
              end
              ...
              # @private
              #
              # GRPC transcoding helper method for the initiate_backup REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::InitiateBackupRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_initiate_backup_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/{data_source}:initiateBackup",
                                                          body: "*",
                                                          matches: [
                                                            ["data_source", %r{^projects/[^/]+/locations/[^/]+/backupVaults/[^/]+/dataSources/[^/]+/?$}, false]
                                                          ]
              ...
              # @private
              #
              # GRPC transcoding helper method for the abandon_backup REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::AbandonBackupRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_abandon_backup_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/{data_source}:abandonBackup",
                                                          body: "*",
                                                          matches: [
                                                            ["data_source", %r{^projects/[^/]+/locations/[^/]+/backupVaults/[^/]+/dataSources/[^/]+/?$}, false]
                                                          ]
              ...
              # @private
              #
              # GRPC transcoding helper method for the finalize_backup REST call
              #
              # @param request_pb [::Google::Cloud::BackupDR::V1::FinalizeBackupRequest]
              #   A request object representing the call parameters. Required.
              # @return [Array(String, [String, nil], Hash{String => String})]
              #   Uri, Body, Query string parameters
              def self.transcode_finalize_backup_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/{data_source}:finalizeBackup",
                                                          body: "*",
                                                          matches: [
                                                            ["data_source", %r{^projects/[^/]+/locations/[^/]+/backupVaults/[^/]+/dataSources/[^/]+/?$}, false]
                                                          ]
              ...
              def self.transcode_fetch_access_token_request request_pb
                transcoder = Gapic::Rest::GrpcTranscoder.new
                                                        .with_bindings(
                                                          uri_method: :post,
                                                          uri_template: "/v1/{name}:fetchAccessToken",
                                                          body: "*",
                                                          matches: [
                                                            ["name", %r{^projects/[^/]+/locations/[^/]+/backupVaults/[^/]+/dataSources/[^/]+/?$}, false]
                                                          ]
