...
class ::Google::Cloud::BackupDR::V1::BackupDR::ClientTest < Minitest::Test
  ...
  def test_remove_data_source
    ...
    remove_data_source_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :remove_data_source, name
      assert_kind_of ::Google::Cloud::BackupDR::V1::RemoveDataSourceRequest, request
      assert_equal "hello world", request["name"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end

    Gapic::ServiceStub.stub :new, remove_data_source_client_stub do
      # Create client
      client = ::Google::Cloud::BackupDR::V1::BackupDR::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      client.remove_data_source({ name: name, request_id: request_id }) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.remove_data_source ::Google::Cloud::BackupDR::V1::RemoveDataSourceRequest.new(name: name, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.remove_data_source({ name: name, request_id: request_id }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.remove_data_source(::Google::Cloud::BackupDR::V1::RemoveDataSourceRequest.new(name: name, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Verify method calls
      assert_equal 5, remove_data_source_client_stub.call_rpc_count
    end
  end

  def test_set_internal_status
    # Create GRPC objects.
    grpc_response = ::Google::Longrunning::Operation.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    set_internal_status_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :set_internal_status, name
      assert_kind_of ::Google::Cloud::BackupDR::V1::SetInternalStatusRequest, request
      assert_equal "hello world", request["data_source"]
      assert_equal "hello world", request["value"]
      assert_equal :BACKUP_CONFIG_STATE_UNSPECIFIED, request["backup_config_state"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end

    Gapic::ServiceStub.stub :new, set_internal_status_client_stub do
      # Create client
      client = ::Google::Cloud::BackupDR::V1::BackupDR::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      client.set_internal_status({ data_source: data_source, value: value, backup_config_state: backup_config_state, request_id: request_id }) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.set_internal_status ::Google::Cloud::BackupDR::V1::SetInternalStatusRequest.new(data_source: data_source, value: value, backup_config_state: backup_config_state, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.set_internal_status({ data_source: data_source, value: value, backup_config_state: backup_config_state, request_id: request_id }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.set_internal_status(::Google::Cloud::BackupDR::V1::SetInternalStatusRequest.new(data_source: data_source, value: value, backup_config_state: backup_config_state, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Verify method calls
      assert_equal 5, set_internal_status_client_stub.call_rpc_count
    end
  end

  def test_initiate_backup
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::BackupDR::V1::InitiateBackupResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    initiate_backup_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :initiate_backup, name
      assert_kind_of ::Google::Cloud::BackupDR::V1::InitiateBackupRequest, request
      assert_equal "hello world", request["data_source"]
      assert_equal "hello world", request["request_id"]
    ...
    Gapic::ServiceStub.stub :new, initiate_backup_client_stub do
      # Create client
      client = ::Google::Cloud::BackupDR::V1::BackupDR::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      client.initiate_backup({ data_source: data_source, request_id: request_id, backup_id: backup_id }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.initiate_backup ::Google::Cloud::BackupDR::V1::InitiateBackupRequest.new(data_source: data_source, request_id: request_id, backup_id: backup_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.initiate_backup({ data_source: data_source, request_id: request_id, backup_id: backup_id }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      client.initiate_backup(::Google::Cloud::BackupDR::V1::InitiateBackupRequest.new(data_source: data_source, request_id: request_id, backup_id: backup_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Verify method calls
      assert_equal 5, initiate_backup_client_stub.call_rpc_count
    end
  end

  def test_abandon_backup
    # Create GRPC objects.
    grpc_response = ::Google::Longrunning::Operation.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    ...
    abandon_backup_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :abandon_backup, name
      assert_kind_of ::Google::Cloud::BackupDR::V1::AbandonBackupRequest, request
      assert_equal "hello world", request["data_source"]
      assert_equal "hello world", request["request_id"]
      refute_nil options
    end

    Gapic::ServiceStub.stub :new, abandon_backup_client_stub do
      # Create client
      client = ::Google::Cloud::BackupDR::V1::BackupDR::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      client.abandon_backup({ data_source: data_source, request_id: request_id }) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.abandon_backup ::Google::Cloud::BackupDR::V1::AbandonBackupRequest.new(data_source: data_source, request_id: request_id) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.abandon_backup({ data_source: data_source, request_id: request_id }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object with options
      client.abandon_backup(::Google::Cloud::BackupDR::V1::AbandonBackupRequest.new(data_source: data_source, request_id: request_id), grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Verify method calls
      assert_equal 5, abandon_backup_client_stub.call_rpc_count
    end
  end
  ...
  def test_finalize_backup
    ...
    finalize_backup_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      assert_equal :finalize_backup, name
      assert_kind_of ::Google::Cloud::BackupDR::V1::FinalizeBackupRequest, request
      assert_equal "hello world", request["data_source"]
      assert_equal "hello world", request["description"]
      assert request.has_description?
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::Timestamp), request["consistency_time"]
      assert request.has_consistency_time?
      assert_equal "hello world", request["request_id"]
      assert_equal "hello world", request["backup_id"]
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::Timestamp), request["recovery_range_start_time"]
      assert request.has_recovery_range_start_time?
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::Timestamp), request["recovery_range_end_time"]
      assert request.has_recovery_range_end_time?
      assert_equal Gapic::Protobuf.coerce({}, to: ::Google::Protobuf::Duration), request["retention_duration"]
      assert request.has_retention_duration?
      refute_nil options
    end

    Gapic::ServiceStub.stub :new, finalize_backup_client_stub do
      # Create client
      client = ::Google::Cloud::BackupDR::V1::BackupDR::Client.new do |config|
        config.credentials = grpc_channel
      end
      ...
      # Use hash object
      client.finalize_backup({ data_source: data_source, description: description, consistency_time: consistency_time, request_id: request_id, backup_id: backup_id, recovery_range_start_time: recovery_range_start_time, recovery_range_end_time: recovery_range_end_time, retention_duration: retention_duration }) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.finalize_backup ::Google::Cloud::BackupDR::V1::FinalizeBackupRequest.new(data_source: data_source, description: description, consistency_time: consistency_time, request_id: request_id, backup_id: backup_id, recovery_range_start_time: recovery_range_start_time, recovery_range_end_time: recovery_range_end_time, retention_duration: retention_duration) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Use hash object with options
      client.finalize_backup({ data_source: data_source, description: description, consistency_time: consistency_time, request_id: request_id, backup_id: backup_id, recovery_range_start_time: recovery_range_start_time, recovery_range_end_time: recovery_range_end_time, retention_duration: retention_duration }, grpc_options) do |response, operation|
        assert_kind_of Gapic::Operation, response
        assert_equal grpc_response, response.grpc_op
        assert_equal grpc_operation, operation
      end
      ...
      # Verify method calls
      assert_equal 5, finalize_backup_client_stub.call_rpc_count
    end
  end

  def test_fetch_access_token
    # Create GRPC objects.
    grpc_response = ::Google::Cloud::BackupDR::V1::FetchAccessTokenResponse.new
    grpc_operation = GRPC::ActiveCall::Operation.new nil
    grpc_channel = GRPC::Core::Channel.new "localhost:8888", nil, :this_channel_is_insecure
    grpc_options = {}
    ...
    fetch_access_token_client_stub = ClientStub.new grpc_response, grpc_operation do |name, request, options:|
      ...
      assert_kind_of ::Google::Cloud::BackupDR::V1::FetchAccessTokenRequest, request
      assert_equal "hello world", request["name"]
      assert_equal 42, request["generation_id"]
      refute_nil options
    end
    ...
    Gapic::ServiceStub.stub :new, fetch_access_token_client_stub do
      ...
      # Use hash object
      client.fetch_access_token({ name: name, generation_id: generation_id }) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
      ...
      # Use protobuf object
      client.fetch_access_token ::Google::Cloud::BackupDR::V1::FetchAccessTokenRequest.new(name: name, generation_id: generation_id) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use hash object with options
      client.fetch_access_token({ name: name, generation_id: generation_id }, grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end

      # Use protobuf object with options
      client.fetch_access_token(::Google::Cloud::BackupDR::V1::FetchAccessTokenRequest.new(name: name, generation_id: generation_id), grpc_options) do |response, operation|
        assert_equal grpc_response, response
        assert_equal grpc_operation, operation
      end
